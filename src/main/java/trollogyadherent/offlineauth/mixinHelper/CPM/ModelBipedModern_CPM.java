...
public class ModelBipedModern_CPM extends ModelBiped {
	...
	public ModelBipedModern_CPM(float scale) {
	...
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
		...
		if(entity instanceof EntityPlayer player && !CPMHelper.isUsingCPMModel(player)) {
