...
* Using a wrapper somehow works. It just works. */
public class IActionObjectGuiLoginWrapper {
    public static Object getActionOpenGuiLogin() {
        return new trollogyadherent.offlineauth.gui.cmm_compat.ActionOpenGuiLogin();
    }
}
