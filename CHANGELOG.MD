...
* Added `enableCapes` config option (client), if disabled (default)
   - Removes cape selection button and also doesn't render capes on players (allows you to avoid the "curse of the permanent cape" in single player)
